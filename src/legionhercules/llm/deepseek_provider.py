"""DeepSeek API provider for LEGIONHERCULES."""
...
class DeepSeekProvider(LLMProvider):
    ...
    async def initialize(self) -> None:
        ...
        logger.info(f"DeepSeek provider initialized (model: {self.model})")
    ...
    async def chat(
        ...
        for msg in messages:
            ...
            deepseek_messages.append(chat_msg.to_openai_dict())
    ...
    def _convert_tool_schema(self, tool: Any) -> dict[str, Any]:
        """Convert tool to DeepSeek format (OpenAI compatible)."""
