"""Fireworks AI API provider for LEGIONHERCULES."""
...
class FireworksProvider(LLMProvider):
    """Fireworks AI provider supporting fast inference for open-source models."""
    ...
    async def initialize(self) -> None:
        ...
        logger.info(f"Fireworks provider initialized (model: {self.model})")
    ...
    async def chat(
        ...
        for msg in messages:
            ...
            fireworks_messages.append(chat_msg.to_openai_dict())
        ...
        try:
            ...
            logger.error(f"Error in Fireworks chat: {e}")
    ...
    async def list_models(self) -> list[str]:
        ...
        try:
            ...
            logger.error(f"Error listing Fireworks models: {e}")
            # Return popular Fireworks models
            return [
