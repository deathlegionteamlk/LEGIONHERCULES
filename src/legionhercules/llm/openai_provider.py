"""OpenAI API provider for LEGIONHERCULES."""
...
class OpenAIProvider(LLMProvider):
    """OpenAI API provider supporting GPT-4, GPT-3.5, and other models."""
    ...
    async def list_models(self) -> list[str]:
        ...
        try:
            ...
            return [m for m in models if any(x in m for x in ["gpt-4", "gpt-3.5", "o1", "o3"])]
        except Exception as e:
